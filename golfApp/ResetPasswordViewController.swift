...
class ResetPasswordViewController : UIViewController {
    ...
    override func viewDidLoad()
    {
        ...
        resetPasswordTextField.textColor = UIColor.black
        resetPasswordTextField.backgroundColor = UIColor.white
        self.resetPasswordTextField.attributedPlaceholder = NSAttributedString(string: "Enter Email to Receive Password Reset Link", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
    }
