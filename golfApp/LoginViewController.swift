...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bottomLine1.frame = CGRect(x: 0, y: textFieldUserName.frame.height-2, width: textFieldUserName.frame.width, height: 4)
        bottomLine1.backgroundColor = UIColor.black.cgColor
        bottomLine1.cornerRadius = 10.0;
        bottomLine1.opacity = 20;
        //bottomLine1.shadowColor = UIColor.white.cgColor
        //bottomLine1.shadowRadius = 9
        bottomLine1.borderColor = UIColor.white.cgColor
        //bottomLine1.borderWidth = 6
        //textFieldUserName.borderStyle = .none
        textFieldUserName.layer.borderColor = UIColor.black.cgColor
        textFieldUserName.backgroundColor = UIColor.white.withAlphaComponent(1)
        textFieldUserName.textColor = UIColor.black
        //textFieldUserName.layer.addSublayer(bottomLine1)
        self.textFieldUserName.attributedPlaceholder = NSAttributedString(string: "Email", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black.withAlphaComponent(0.75)])
        ...
        textFieldPassword.backgroundColor = UIColor.white.withAlphaComponent(1)
        textFieldPassword.textColor = UIColor.black
        self.textFieldPassword.attributedPlaceholder = NSAttributedString(string: "Password", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black.withAlphaComponent(0.75)])
