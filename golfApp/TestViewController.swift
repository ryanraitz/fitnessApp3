...
class TestViewController : UIViewController, WKNavigationDelegate {
    ...
    @IBAction func watchDemo(_ sender: Any) {
        ...
        // guard let path = Bundle.main.path(forResource: selectedLocation?.userVideos,
        //   ofType: "mp4") else { return }
        //let url = selectedLocation?.userVideos
...
//        if selectedLocation?.userVideos != "pyramid"
//        {
//        let url = selectedLocation?.userVideos
//        guard let videoLink = URL(string: url!) else { return }
//        //print(url!)
...
//        myTextLabel.text = selectedLocation?.userCreditsString
//
//        //Dynamically size overview text field based on content
//        myTextLabel.sizeToFit()
//        myLabel.text = selectedLocation?.userEmail
//
//        //Dynamically size mind muscle connection text field based on content
//        mindMuscleConnectionTextLabel.text = selectedLocation?.userSubscriptionID
